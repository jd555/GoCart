...
function rotate_banner()
{
	...
	$('.banner_container:eq('+cnt+')').fadeOut(1000);
	cnt++;
	if(cnt == $('.banner_container').length)
	{
		cnt = 0;
	}
	$('.banner_container:eq('+cnt+')').fadeIn(1000,function(){
...
<div id="top_menu_container" class="full_wrap">
	<div class="wide_wrap">
		...
		<li class="bold">
			...
			elseif (isset($order_complete) && $order_complete)
			{
				echo lang('order_complete');
			}
			else
			{
...
<div class="full_wrap">
	...
	<!--
	<a href='#'><img src="<?php echo  base_url('uploads/87d92c6a177c3db71a56950571827d2d.gif');?>" /></a>
	-->

		</div><!-- <div id="banners"> -->
	</div> <!-- <div id="header" class="wide_wrap"> -->
</div> <!-- full-wrap -->
