			...
			<?php echo form_open('secure/my_account'); ?>
				...
				<div class="form_wrap">
					<div>
						...
						<?php if($customer['group_id']!=0 && $customer['pricelevels']['tierdescription'] !='')
							echo '<br><span class="tierdescription">Based on your institution, you qualify for ' . $customer['pricelevels']['tierdescription'] . ' pricing</span>'; ?>
					</div>
				</div>
				<div class="form_wrap">
					<div>
